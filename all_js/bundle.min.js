...
!function(t, e) {
                    ...
                    new Promise(function(n) {
                        function i() {
                            if (4 === a.readyState) {
                                if (200 !== a.status)
                                {
                                    console.log('No print operation, looks like server is down or your internet connection is too slow')
    ...
    L.Control.EasyPrint = L.Control.extend({
        ...
        printMap: function(t, e) {
            ...
            this.options.hideClasses.length > 0 && this._toggleClasses(this.options.hideClasses);
        ...
        _printOpertion: function(t) {
            var e = this
              ...
              console.info(this.mapContainer)
              console.info(this.mapContainer.style)
              console.info($('#map').width()+' is the width');
                   console.warn(e.mapContainer);
                   var height=parseInt(e.mapContainer.style.height);//.replace("px"))
                   var height=$('#map').height();
                   var width=$('#map').width();
                console.info(height+' is the high');
            ...
            //    console.log(o)
                ...
                alert('Print operation failed... sorry')
            })
        },
